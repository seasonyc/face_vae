...
from tensorflow.keras.layers import Input, Dense, ZeroPadding2D, Activation, Add, Conv2D, Flatten, Lambda, UpSampling2D, BatchNormalization, LeakyReLU, Conv2DTranspose, Reshape
...
'''
2nd best but no color tripe
print('test ................instance epoch 3 alpha 1.5  128........................................\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
vae_dfc = load_model('face-vae1546192514.8240976')
test_vae(vae_dfc)

best

print('test ................instance epoch 3 alpha 1.0  256........................................\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
vae_dfc = load_model('face-vae1546231811.4499974')
test_vae(vae_dfc)


to test

vae_dfc = train(selected_pm_layers, alpha = 1.0, latent_dim = 240)
save_model(vae_dfc, 'face-vae' + str(time.time()))
test_vae(vae_dfc)
'''
